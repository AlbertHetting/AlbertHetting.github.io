    ...
    <div>
          ...
          <div className="Projekter">
            ...
            <div className="program-icons reveal stagger">
              <div className="ProjectText">
                ...
                <p>
                  {" "}
                  Completed school or work <br></br> projects - check back to
                  see
      ...
      <div className="program-icons reveal stagger">
        <section className="AboutMeText">
          ...
          <p>
            {" "}
            My skills range from communications, project management & training
            to technical support, database administration, & video production.
            My strongest attributes are: Discipline, focus, persistence,
            passion, & consistency. In digital workflows I always strive to
            create something better than my previous project.
          </p>
        </section>
      </div>
    </div>
